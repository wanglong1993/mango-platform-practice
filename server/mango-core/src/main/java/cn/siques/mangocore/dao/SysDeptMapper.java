...
import cn.siques.mangocore.entity.SysDeptExample;
import cn.siques.mangocore.entity.SysDeptKey;
...
public interface SysDeptMapper {
    ...
    @Select({
            "select",
            "id, name, parent_id, order_num, create_by, create_time, last_update_by, last_update_time, dept_tree,",
            "del_flag ",
            "from sys_dept",
            "where id = #{id,jdbcType=BIGINT}"
    })
