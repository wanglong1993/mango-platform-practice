...
import cn.siques.mangocore.entity.SysRoleDeptExample.Criteria;
import cn.siques.mangocore.entity.SysRoleDeptExample.Criterion;
import cn.siques.mangocore.entity.SysRoleDeptExample;
import java.util.List;
import java.util.Map;

public class SysRoleDeptSqlProvider {
     ...
     */
    public String countByExample(SysRoleDeptExample example) {
        BEGIN();
        SELECT("count(*)");
        FROM("sys_role_dept");
     ...
     * @mbggenerated Mon Jun 29 20:40:38 CST 2020
     */
    public String deleteByExample(SysRoleDeptExample example) {
        BEGIN();
        DELETE_FROM("sys_role_dept");
        applyWhere(example, false);
        return SQL();
    }
     ...
     * @mbggenerated Mon Jun 29 20:40:38 CST 2020
     */
    public String insertSelective(SysRoleDept record) {
        BEGIN();
        INSERT_INTO("sys_role_dept");
     ...
     * @mbggenerated Mon Jun 29 20:40:38 CST 2020
     */
    public String selectByExample(SysRoleDeptExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        SysRoleDept record = (SysRoleDept) parameter.get("record");
        SysRoleDeptExample example = (SysRoleDeptExample) parameter.get("example");
     ...
     * @mbggenerated Mon Jun 29 20:40:38 CST 2020
     */
    public String updateByPrimaryKeySelective(SysRoleDept record) {
        BEGIN();
        UPDATE("sys_role_dept");
     ...
     * @mbggenerated Mon Jun 29 20:40:38 CST 2020
     */
    protected void applyWhere(SysRoleDeptExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
