...
public class RedisUtil {
    ...
    private static RedisTemplate<String, Object> redisTemplate = ContextUtil.getBean("redisTemplate");;
    {
     ...
     * <br>
     */
    public static void putCacheStr(String key, String data, Long minus, TimeUnit t) {
