package cn.siques.mangomail.service;

import cn.hutool.core.io.resource.ResourceUtil;
import cn.siques.mangomail.MangoMailApplicationTests;
 ...
 */
public class MailServiceTest extends MangoMailApplicationTests {
    @Autowired
    ...
    public void sendSimpleMail() {
        mailService.sendSimpleMail("943452349@qq.com", "这是一封简单邮件", "这是一封普通的SpringBoot测试邮件");
    }
    ...
    public void sendHtmlMail() throws MessagingException {
        ...
        mailService.sendHtmlMail("943452349@qq.com", "这是一封模板HTML邮件", emailTemplate);
    }
    ...
    public void sendAttachmentsMail() throws MessagingException {
        ...
        mailService.sendAttachmentsMail("943452349@qq.com", "这是一封带附件的邮件", "邮件中有附件，请注意查收！", resource.getPath());
    }
