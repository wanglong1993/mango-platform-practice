...
import cn.siques.mango.entity.SysDeptExample.Criteria;
import cn.siques.mango.entity.SysDeptExample.Criterion;
...
public class SysDeptSqlProvider {
     ...
     * @mbggenerated Mon Jun 29 20:40:38 CST 2020
     */
    protected void applyWhere(SysDeptExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
